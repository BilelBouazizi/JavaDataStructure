...
public class LinkedListD <T> {
    ...
    public void InsertBefore(NodeD next_node, T new_data) {
    ...
    public void InsertAfter(NodeD prev_Node, T new_data) {
    ...
    public void printlist(NodeD node) {
        NodeD last = null;
